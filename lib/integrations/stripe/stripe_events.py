...
def get_payment_object(ob):
    pmt = Payment(user=payment.buyer, product=payment.product, price=payment.price)
    if(payment.type == "payment"):
        pmt.receipt = payment.receipt
    
    if(payment.type == "invoice"):
        pmt.invoice = payment.invoice
    return pmt
